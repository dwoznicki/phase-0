...
What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  ...
  I faltered a bit when defining the children. I forgot to add commas after the objects, which confused JS greatly (at least it threw an error instead of trying to fix it itself). I saw the problem, added the commas, and it worked. It can get confusing when you have nested objects, but you have to remember to add in the comma.

How difficult was it to add and delete properties outside of the object itself?

  Not very difficult, as long as you know the syntax. I took a few notes when reading Eloquent JavaScript, so I could refer back to the notation without much trouble.

What did you learn about manipulating objects in this challenge?

  I learned that you can't add semicolons inside of an object. I tried doing so, and JS threw me an error.
